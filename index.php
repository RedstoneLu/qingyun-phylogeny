      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=Rit7cDq" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con1.value='144G网页制作';
            con2.value='网站发展流程页面';
            con3.value='2017.1.1系统正式起步。';
            con4.value='2017.1.6系统完成响应式手机版。';
			con5.value='2017.1.7新增大量模板。';
			con6.value='2017.1.14可自定义图片与音乐。';
			con7.value='2017.1.20系统宣布开源。';
			con8.value='2017.1.27完成APP手机版。';
            con9.value='前路虽漫漫，小彬不怕难。有求必有应，质量准过关。自是高人助，';
            con10.value='远望俯平川。天地感其善，鬼神器之酸。昔日不忘恩，今朝永为伴。';
			con11.value='http://www.sansuib.com';
			con12.value='123456';
			con13.value='http://m2.music.126.net/bXp6VBHfxlCfT4Z9Aei-8Q==/3440371892441683.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
